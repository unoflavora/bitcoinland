...
export default function Stats()
{
  ...
  return <div className="flex flex-col gap-10 px-5 py-5 md:px-10 lg:px-36">
   <MotionDiv>
        <h1 className='text-5xl lg:text-9xl text-black text-center font-bold pb-10'> Discover our mad dream of making the world play!</h1>
   </MotionDiv>

    <div className="flex flex-col md:flex-row gap-5 lg:px-56">
        {stats.map((stat, i) => <MotionDiv key={'stat' + i}>
            <div className={`py-10 px-5 text-3xl lg:text-7xl lg:px-10 lg:p-24 lg:py-36 flex flex-col gap-4 bg-gradient-to-b from-red-100 to-yellow-100 rounded-2xl`}>
