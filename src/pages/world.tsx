...
export default function World()
{
    ...
    return <>
        ...
        <iframe ref={iframeRef} className={`w-full min-h-screen grow transition-all ${isPlaying ? "p-0 pt-0 md:rounded-b-0 pointer-events-auto z-[10000]" : "pointer-events-none"} `}  
