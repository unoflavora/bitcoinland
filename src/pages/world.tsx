...
export default function World()
{
    ...
    return <>
        ...
        <iframe ref={iframeRef} className={`w-full min-h-[96dvh] grow transition-transform ${isPlaying ? "translate-y-0 md:rounded-b-0 pointer-events-auto z-[10000]" : "translate-y-12 xl:translate-y-24 pointer-events-auto"} `}  
