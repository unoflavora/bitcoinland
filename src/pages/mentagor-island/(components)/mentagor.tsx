...
export default function Mentagor()
{
    ...
    return <MotionDiv>
    <div className={"relative overflow-y-hidden flex flex-col justify-center items-center px-5 lg:px-36 xl:px-56 gap-10 lg:gap-24 bg-[#F5F5F5] py-20 " + parentElementStyle}>
        ...
        <Image className="w-full  rounded-xl" src="/mentagor/hero.webp" width={800} height={500} alt="map of pengkalan hulu" loading="eager"/>
