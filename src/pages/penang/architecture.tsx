...
export default function Architecture()
{
    return <div className="w-full h-full flex justify-center items-center flex-col gap-5">
        <div className="relative w-fit  ">
            <Image className="rounded-xl" src="/penang/hotel.png" width={900} height={500} alt="hotel plan"/>
            ...
            {[
                {
                    ...
                    url: "/penang/hotel1.png"
                },
                {
                    title: "Vibrant Waterfront",
                    url: "/penang/hotel3.png"
                },
                {
                    title: "Bitcoins on The Street",
                    url: "/penang/hotel2.png"
                },
        ...
        <div className="relative w-full flex flex-col md:flex-row rounded-xl bg-gradient-to-t md:bg-gradient-to-l from-gold ">
            <Image className="rounded-xl" src="/penang/canal-plan.png" width={500} height={500} alt="hotel plan"/>
        ...
        <Image className="rounded-xl" src="/penang/canals.png" width={1200} height={500} alt="hotel plan"/>
