...
export default function TouchDown()
{
    return <div className=" flex flex-col gap-5 h-full">
        ...
        <div className="w-full h-full">
            <Image  className="max-md:hidden rounded-xl" src="/penang/george-town.webp" width={480} height={376}  alt="penang site location"/>
        </div>
        ...
        <article className="w-full flex flex-col max-md:items-center justify-center  gap-5 ">
                ...
                <Image className="md:hidden rouneded-xl" src="/penang/george-town.webp" width={480} height={376} alt="penang site location"/>
